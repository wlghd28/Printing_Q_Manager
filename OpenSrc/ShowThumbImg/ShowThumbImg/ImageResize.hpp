...
HBITMAP CImageResize::ScaleBitmap(HBITMAP hBmp, 
	WORD wNewWidth, 
	WORD wNewHeight)
{
	BITMAP bmp;
...
BITMAPINFO* CImageResize::PrepareRGBBitmapInfo(WORD wWidth, WORD wHeight)
{
...
float* CImageResize::CreateCoeff(int nLen, int nNewLen, BOOL bShrink)
{
	int nSum = 0, nSum2;
...
void CImageResize::ShrinkData(BYTE *pInBuff, WORD wWidth, WORD wHeight,
...
void CImageResize::EnlargeData(BYTE *pInBuff, WORD wWidth, WORD wHeight,
	BYTE *pOutBuff, WORD wNewWidth, WORD wNewHeight)
{
	BYTE  *pLine = pInBuff, *pPix 
